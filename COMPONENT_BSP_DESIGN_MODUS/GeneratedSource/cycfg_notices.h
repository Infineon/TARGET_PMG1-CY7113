...
#define CYCFG_NOTICES_H
    ...
    #error "Unexpected target MCU; expected CYPM1311-48LQXI. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
